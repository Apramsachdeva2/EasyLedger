...
<h1 style=" font-family:georgia;font-weight: bold; font-size: 70px; margin-top:4px;">Update Bill</h1>

<div class="form-bck" >


<s:form method="post" action="saveBill" modelAttribute="bill">

<s:input path="billId" type="hidden" name="billId"  />
...
<s:label path="date"  class="form-label" style="margin-top:3%;font-family:monaco;font-size:25px;">Bill Date</s:label>
