...
<h1 style=" font-family:georgia;font-weight: bold; font-size: 70px; margin-top:4px;">Update Receipt</h1>
...
<s:input path="recieptId" type="hidden" name="recieptId"  />
...
<s:label path="date"  class="form-label" style="margin-top:3%;font-family:monaco;font-size:25px;">Receipt Date</s:label>
